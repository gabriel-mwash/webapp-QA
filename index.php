...
<body style="background: url(&quot;assets/img/Frame%2016%20(2).svg&quot;) center / auto repeat, #ffffff;">
    ...
    <form class="pulse animated question-form">
        ...
        <div><textarea class="form-control question-area" placeholder="type question here"></textarea></div><label class="form-label row-cols-sm-6">* Not mandatory</label>
        ...
        <div class="question-btns"><a class="btn btn-primary btn-lg active fw-bolder mod-login-btn" role="button" data-bss-hover-animate="tada" data-bs-target="moderator.php" href="moderator.php" style="background: #94d82d;color: rgb(3,1,1);">moderator login</a><a class="btn btn-primary btn-lg active fw-bolder submit-btn" role="button" data-bss-hover-animate="tada" href="continue.php" data-bs-target="continue.php" link="continue.php" style="background: #94d82d;color: rgb(0,0,0);">submit</a></div>
    </form>
